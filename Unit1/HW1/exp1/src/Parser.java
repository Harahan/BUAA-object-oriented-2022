...
public class Parser {
    private final Pattern numberPattern = Pattern.compile("([a-z]|[A-Z])"); // TODO
        ...
        if (position != -1) {
            ...
            if (position != -1) {
                ...
                if (!expression.equals("")) {
                    ...
                    // TODO
                    if (matcher.find()) {
                        //System.out.println(parameters.get(matcher.group()).intValue());
                        return new Num(parameters.get(matcher.group()).intValue());
                    } else {
