...
public class StateDiagram {
    ...
    private final HashSet<MyStateMachine> myStateMachinesForCheck = new HashSet<>();
    ...
    public void parseUmlStateMachine(UmlStateMachine umlStateMachine) {
        ...
        myStateMachinesForCheck.add(tmpList.get(0));
    ...
    public void parseUmlEvent(UmlEvent umlEvent) {
        ...
        ((MyState) myElements.get(umlTransition.getSource())).addTrigger(
                (MyState) myElements.get(umlTransition.getTarget()),
                umlEvent.getId(), umlEvent.getName(), umlTransition.getGuard());
    }
    ...
    public void checkForUml008() throws UmlRule008Exception {
        for (MyStateMachine item : myStateMachinesForCheck) {
            if (!item.isCheckRule008()) {
