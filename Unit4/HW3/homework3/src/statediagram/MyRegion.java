...
public class MyRegion {
    ...
    private final HashSet<MyState> totStatesForCheck = new HashSet<>();

    public void addState(MyState myState) {
        ++stateNum;
        totStatesForCheck.add(myState);
    ...
    public boolean isCheckRule009() {
        for (MyState item : totStatesForCheck) {
