...
public class Path implements Iterable<Integer> {        // 包含题目[10]-[14]
    ...
    /*@ public normal_behavior
      ...
      @ assignable \nothing;
      @ signals (IndexOutOfBoundsException e) index < 0 || index >= size(); //TODO: [10] ok
      @*/
    ...
    //@ ensures \result == (\exists int i; 0 <= i && i < nodes.length; nodes[i] == nodeId);    //TODO: [11] ok
    ...
    public /*@ pure @*/ boolean equals(final Object obj) {
        ...
        while (iterator.hasNext() || myIterator.hasNext()) {
            if (!iterator.next().equals(myIterator.next())) {  //TODO: [12] ok
                return false;
            }
        }
        return true;
    ...
    public /*@ pure @*/ boolean isValid() {
        return (size() >= 2 && size() <= getDistinctNodeCount() + 1);   //TODO: [13] ok
    }
    ...
    public /*@ pure @*/ Path extractLoopPath() {
        ...
        loopStartIndex = nodeToIndex.get(nodes.get(index)); //TODO: [14] ok
        loopLastIndex = index;
